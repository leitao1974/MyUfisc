...
# Inserir Google API Key dinamicamente
...
if google_api_key:
    try:
        client = build('aiplatform', 'v1', developerKey=google_api_key)

        project_id = st.text_input("ID do Projeto Google")
        location = st.text_input("Localização do projeto", value="us-central1")
...
if file_text and google_api_key and selected_model:
